...
class DomeTrajectoryMCS(salobj.BaseScript):
    ...
    async def run(self):
        ...
        assert dome_az_cmd_state.commandedState == AzimuthCommandedState.STOP, \
        ...
        atdometraj_max_az = 5
        scaled_atdometraj_max_az = atdometraj_max_az/math.cos(self.config.el*RAD_PER_DEG)
        ...
        self.log.info(f"Slewing telescope to elevation={self.config.el:0.2f}, "
