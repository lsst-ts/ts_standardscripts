...
__all__ = ["BaseTakeAOSSequence", "Mode"]
...
class BaseTakeAOSSequence(BaseBlockScript):
    ...
    * sequence {n} of {m}: before taking a sequence.
    ...
    def __init__(self, index, descr="Take AOS sequence.") -> None:
