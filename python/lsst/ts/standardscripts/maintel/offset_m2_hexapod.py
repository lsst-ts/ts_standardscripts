...
class OffsetM2Hexapod(salobj.BaseScript):
    ...
    **Details**
    ...
    This script can be used to apply a user-specified offset to any of
    the M2 Hexapod axes.
    """
    ...
    async def run(self):
        ...
        await self.checkpoint("Applying M2 Hexapod offsets...")
        await self.mtcs.offset_m2_hexapod(**self.offsets, sync=self.sync)
