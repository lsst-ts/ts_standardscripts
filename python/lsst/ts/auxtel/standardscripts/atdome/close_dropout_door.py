...
__all__ = ["CloseDropoutDoor"]

from lsst.ts import salobj
from lsst.ts.observatory.control.auxtel.atcs import ATCS


class CloseDropoutDoor(salobj.BaseScript):
    ...
    **Checkpoints**
    ...
    def __init__(self, index):
        super().__init__(index=index, descr="Close the ATDome dropout door.")
    ...
    async def run(self):
        await self.checkpoint("Closing dropout door.")
