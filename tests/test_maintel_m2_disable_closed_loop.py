...
class TestDisableM2ClosedLoop(
    ...
    async def basic_make_script(self, index):
        self.script = DisableM2ClosedLoop(index=index)
    ...
    async def test_configure_with_program_reason(self):
        async with self.make_dry_script():
            ...
            assert (
                ...
                == "DisableM2ClosedLoop BLOCK-123 202312190001 SITCOM-321"
            )
    ...
    async def test_run(self):
        async with self.make_script():
            ...
            self.script.mtcs.disable_m2_balance_system.assert_awaited_once()
    ...
    async def test_executable(self):
        ...
        script_path = scripts_dir / "maintel" / "m2" / "disable_closed_loop.py"
        print(script_path)
